...
INCLS = -I/usr/local/include -I$(HANCOCKTOOLS_ROOT) -I$(CMPFIT_ROOT) -I${LIBCLIDAR_ROOT} -I. -I/usr/include/libgeotiff -I/usr/include/gdal -I${GSL_ROOT} -I${HDF5_LIB}/include  #-I${HDF5_LIB}/include -I/anaconda3/include
CFLAGS += -Wall 
#CFLAGS += -Wl,--verbose
#CFLAGS += -O3
CFLAGS += -g
