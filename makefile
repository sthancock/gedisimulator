...
LIBS = -lm -lgsl -lgslcblas -ltiff -lgeotiff -lhdf5 -L${GSL_ROOT} -lgdal -L${HDF5_LIB}/lib -L/usr/lib/x86_64-linux-gnu/hdf5/openmpi #-L/anaconda3/lib
INCLS = -I/usr/local/include -I$(HANCOCKTOOLS_ROOT) -I$(CMPFIT_ROOT) -I${LIBCLIDAR_ROOT} -I. -I/usr/include/libgeotiff -I/usr/include/gdal -I${GSL_ROOT} -I${HDF5_LIB}/include  -I/usr/include/hdf5/serial -I/usr/include/geotiff -I/usr/include/hdf5/openmpi #-I${HDF5_LIB}/include -I/anaconda3/include
CFLAGS += -Wall 
#CFLAGS += -Wl,--verbose
#¢CFLAGS += -O3
CFLAGS += -g
